...
export type DeliveryPartnerWhereInput = {
  ...
  phone?: Prisma.StringNullableFilter<"DeliveryPartner"> | string | null
  trackingUrl?: Prisma.StringNullableFilter<"DeliveryPartner"> | string | null
...
export type DeliveryPartnerScalarWhereWithAggregatesInput = {
  ...
  phone?: Prisma.StringNullableWithAggregatesFilter<"DeliveryPartner"> | string | null
  trackingUrl?: Prisma.StringNullableWithAggregatesFilter<"DeliveryPartner"> | string | null
}
...
export type DeliveryPartnerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "phone" | "trackingUrl", ExtArgs["result"]["deliveryPartner"]>
...
export interface DeliveryPartnerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more DeliveryPartners that matches the filter.
   * @param {DeliveryPartnerFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const deliveryPartner = await prisma.deliveryPartner.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.DeliveryPartnerFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a DeliveryPartner.
   * @param {DeliveryPartnerAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const deliveryPartner = await prisma.deliveryPartner.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.DeliveryPartnerAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface DeliveryPartnerFieldRefs {
  ...
  readonly trackingUrl: Prisma.FieldRef<"DeliveryPartner", 'String'>
}
...
/**
 * DeliveryPartner findRaw
 */
export type DeliveryPartnerFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * DeliveryPartner aggregateRaw
 */
export type DeliveryPartnerAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
